<template>
  <div class="MoviesComingSoon container" :style="'width:'+(appwid()<1300?appwid():appwid()*0.8)+'px;margin:0 auto'">
...
export default {
  ...
  methods: {
    pagechange: function (currentPage) {
      ...
      this.$router.push('/movies/coming_soon?page=' + currentPage)
    },
    handleRouteChange () {
      ...
      axios
        .get(this.server_host_java + '/v1/movies/coming_soon?page=' + this.page)
        .then(response => {
